...
public class Utils {
    ...
    //Enter Your Invoice Number from Codecanyon
    public static String INVOICENUMBER = "IVIP37890119";
    public static String TikTokUrl = "http://codingdunia.com/ccprojects/tiktok/api/getvideoInfo";
